...
## Tutoriais
- [Primeiros passos com NodeJS](http://tableless.com.br/primeiros-passos-com-node-js/)
...
- [Entendendo event loop no NodeJS](http://imasters.com.br/front-end/javascript/entendendo-o-event-loop-do-node-js/)
- [Arquiteturas assíncronas de JavaScript: Events vs Promises](imasters.com.br/front-end/javascript/arquiteturas-assincronas-de-javascript-events-vs-promises/)

## Comunidades
- [NodeBR](http://nodebr.com/)
- [NodeJS Brasil](http://nodejsbrasil.com.br/)
  - [Grupo Facebook](https://www.facebook.com/groups/nodejsbrasil/)
- [[GitHub] sindresorhus / awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs)

## Guias
- [NodeJS para Iniciantes](http://udgwebdev.com/nodejs/)
- [Guia soudev de NodeJS](https://github.com/soudev/knowledge.mine/blob/master/stuff/nodejs.md)
